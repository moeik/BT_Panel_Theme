...
Set_Phpini(){
	...
	sed -i 's/disable_functions =.*/disable_functions = passthru,exec,system,putenv,pcntl_exec,chroot,chgrp,chown,shell_exec,popen,proc_open,ini_alter,ini_restore,dl,openlog,syslog,readlink,symlink,popepassthru/g' ${php_setup_path}/etc/php.ini
