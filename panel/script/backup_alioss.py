...
class alioss_main:
    ...
    __setupPath = '/www/server/panel/plugin/alioss'
    def __conn(self):
    ...
    def SetConfig(self,get):
        path = self.__setupPath + '/config.conf';
        conf = get.access_key + '|' + get.secret_key +'|' + get.bucket_name + '|' + get.bucket_domain;
    ...
    def upload_file(self,filename):
        ...
        try:
            ...
            #result = bucket.put_object_from_file(key, filename)  #直接上传
